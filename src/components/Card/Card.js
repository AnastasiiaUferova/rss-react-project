...
export const Card = (props) => {
    ...
    return (React.createElement("div", { className: "card" },
        React.createElement("img", { className: "card__pic", src: image, alt: `Picture of "${name}"` }),
        React.createElement("div", { className: "card__text-container" },
            React.createElement("p", { className: "card__text" }, name),
            React.createElement("p", { className: "card__text card__text_category" }, categories?.join(', '))),
        React.createElement("div", { className: "card__subtext-container" },
            ...
            React.createElement("div", { className: "card__button-container" },
