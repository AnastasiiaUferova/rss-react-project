...
describe('RadioInput', () => {
  ...
  it('renders with the correct label', () => {
    const { getByLabelText } = render(<RadioInput {...defaultProps} />);
  ...
  it('sets the "checked" attribute correctly', () => {
    const { getByLabelText, rerender } = render(<RadioInput {...defaultProps} />);
    expect(getByLabelText('Test Label')).not.toBeChecked();
    rerender(<RadioInput {...defaultProps} checked={true} />);
